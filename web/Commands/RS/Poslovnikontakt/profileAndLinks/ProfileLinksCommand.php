...
class ProfileLinksCommand extends Command
{
    ...
    */
    protected function execute(InputInterface $input, OutputInterface $output) : void
    {
        ...
        for($i = 0; $i < $totalRecords; $i++ ){
            ...
            $process = new Process("php application.php rs:vacuuming-28 --url='$url'");
            $process->start();
    ...
    */
    ...
    {
        $filter = $crawler->filter('.thumbnail + .description > h3 > a')->eq($k)->attr('href');
    ...
    */
    ...
    {
        try{
            return $crawler->filter('.thumbnail + .description > h3 > a')->count();
        } catch (\Exception $e){
            return 0;
        }
    }
