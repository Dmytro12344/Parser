...
class ProfileLinksCommand extends Command
{
    ...
    */
    protected function execute(InputInterface $input, OutputInterface $output) : void
    {
        ...
        for($i = 0; $i < $totalRecords; $i++ ){
            ...
            $process = new Process("php application.php rs:vacuuming-24 --url='$url'");
            $process->start();
    ...
    */
    ...
    {
        $filter = $crawler->filter('.listing_results_result')->eq($k)->filter('h4 > a')->attr('href');
    ...
    */
    ...
    {
        try{
            return $crawler->filter('.listing_results_result')->count();
        } catch (\Exception $e){
            return 0;
        }
    }
