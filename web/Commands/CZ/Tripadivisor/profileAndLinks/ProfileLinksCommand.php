...
class ProfileLinksCommand extends Command
{
    ...
    */
    protected function execute(InputInterface $input, OutputInterface $output) : void
    {
        ...
        for($i = 0; $i < $totalRecords; $i++ ){
            ...
            $process = new Process("php application.php cz:vacuuming-12 --url='$url'");
            $process->start();
    ...
    */
    ...
    {
        $filter = $crawler->filter('.restaurants-list-ListCell__nameBlock--1hL7F > span > a')->eq($k)->attr('href');
        return urldecode('https://www.tripadvisor.cz' . $filter);
    }
    ...
    */
    ...
    {
        try{
            return (int)$crawler->filter('.restaurants-list-List__wrapper--3PzDL > .restaurants-list-ListCell__cellContainer--2mpJS')->count();
        } catch (\Exception $e){
            return 0;
        }
    }
