...
class ProfileLinksCommand extends Command
{
    ...
    */
    protected function execute(InputInterface $input, OutputInterface $output) : void
    {
        ...
        for($i = 0; $i < $totalRecords; $i++ ){
            ...
            $process = new Process("php application.php cz:vacuuming-43 --url='$url'");
            $process->start();
    ...
    */
    ...
    {
        $filter = $crawler->filter('.restaurant-list-content > article')->filter('a')->eq($k)->attr('href');
        return urldecode('https://www.restu.cz' . $filter);
    }
    ...
    */
    ...
    {
        try{
            return (int)$crawler->filter('.restaurant-list-content > article')->count();
        } catch (\Exception $e){
            return 0;
        }
    }
